...
describe 'Admin Invoices Index Page' do
  ...
  it 'shows the discounted revenue on the invoice' do
    ...
    expect(page).to have_content('Discounted Revenue: $158.4')
    expect(page).to_not have_content('Discounted Revenue: $162.0')

    visit admin_invoice_path(invoice_8)

    expect(page).to have_content('Discounted Revenue: $1.0')
  end
end
# bundle exec rspec spec/features/admin/invoices/show_spec.rb
