...
RSpec.describe 'editing a bulk discount' do
  it 'links to a form that is prefilled with the discount attributes' do
    ...
    expect(page).to have_field('Thresholds', with: '15')
...
# bundle exec rspec spec/features/bulk_discounts/edit_spec.rb
