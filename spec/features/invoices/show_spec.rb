...
RSpec.describe 'invoices show' do
  ...
  it 'shows the total revenue for the merchant from the invoice' do
    ...
    discount = BulkDiscount.create!(percent_off: 5, thresholds: 10, merchant_id: merchant1.id)
    ...
    discount4 = BulkDiscount.create!(percent_off: 5, thresholds: 10, merchant_id: merchant2.id)
    discount5 = BulkDiscount.create!(percent_off: 10, thresholds: 15, merchant_id: merchant2.id)
    discount6 = BulkDiscount.create!(percent_off: 15, thresholds: 20, merchant_id: merchant2.id)
    discount7 = BulkDiscount.create!(percent_off: 20, thresholds: 30, merchant_id: merchant2.id)

    visit merchant_invoice_path(merchant1, invoice_1)

    expect(page).to have_content('Total Discounted Revenue: $158.4')
    expect(page).to_not have_content('Total Discounted Revenue: $162.0')
  ...
  it 'shows the total revenue for the merchant from the invoice' do
    ...
    ii_2 = InvoiceItem.create!(invoice_id: invoice_2.id, item_id: item_1.id, quantity: 1, unit_price: 10, status: 2)
    ii_3 = InvoiceItem.create!(invoice_id: invoice_3.id, item_id: item_2.id, quantity: 2, unit_price: 8, status: 2)
    ii_4 = InvoiceItem.create!(invoice_id: invoice_4.id, item_id: item_3.id, quantity: 16, unit_price: 5, status: 1)
    ii_6 = InvoiceItem.create!(invoice_id: invoice_5.id, item_id: item_4.id, quantity: 1, unit_price: 1, status: 1)
    ii_7 = InvoiceItem.create!(invoice_id: invoice_6.id, item_id: item_7.id, quantity: 1, unit_price: 3, status: 1)
    ii_8 = InvoiceItem.create!(invoice_id: invoice_7.id, item_id: item_8.id, quantity: 1, unit_price: 5, status: 1)
    ii_9 = InvoiceItem.create!(invoice_id: invoice_7.id, item_id: item_4.id, quantity: 1, unit_price: 1, status: 1)
    ii_10 = InvoiceItem.create!(invoice_id: invoice_8.id, item_id: item_5.id, quantity: 20, unit_price: 1, status: 1)
    ii_10 = InvoiceItem.create!(invoice_id: invoice_8.id, item_id: item_6.id, quantity: 3, unit_price: 1, status: 1)
    ii_11 = InvoiceItem.create!(invoice_id: invoice_1.id, item_id: item_8.id, quantity: 12, unit_price: 6, status: 1)
